...
-- Users (fixed: first_name/last_name match model; added phone_number for WhatsApp notification testing)
INSERT INTO users (id, email, first_name, last_name, phone_number, cognito_sub, role, neighbourhood_id, created_at) VALUES
('b1111111-1111-1111-1111-111111111111', 'admin@northwood.com', 'Sarah', 'Johnson', '0821110001', 'cognito-admin-1', 'NEIGHBOURHOOD_ADMIN', 'a1111111-1111-1111-1111-111111111111', now()),
('b2222222-2222-2222-2222-222222222222', 'admin@sunset.com', 'Mark', 'Williams', '0821110002', 'cognito-admin-2', 'NEIGHBOURHOOD_ADMIN', 'a2222222-2222-2222-2222-222222222222', now()),
('b3333333-3333-3333-3333-333333333333', 'security@northwood.com', 'James', 'Anderson', '0821110003', 'cognito-security-1', 'SECURITY_OFFICER', 'a1111111-1111-1111-1111-111111111111', now()),
('b4444444-4444-4444-4444-444444444444', 'resident1@northwood.com', 'Emily', 'Davis', '0826263502', 'cognito-resident-1', 'RESIDENT', 'a1111111-1111-1111-1111-111111111111', now()),
('b5555555-5555-5555-5555-555555555555', 'resident2@northwood.com', 'Michael', 'Brown', '0837654321', 'cognito-resident-2', 'RESIDENT', 'a1111111-1111-1111-1111-111111111111', now()),
('b6666666-6666-6666-6666-666666666666', 'newuser1@example.com', 'Lisa', 'Martinez', NULL, 'cognito-new-1', 'USER', NULL, now()),
('b7777777-7777-7777-7777-777777777777', 'newuser2@example.com', 'David', 'Garcia', NULL, 'cognito-new-2', 'USER', NULL, now()),
('b8888888-8888-8888-8888-888888888888', 'newuser3@example.com', 'Jennifer', 'Taylor', NULL, 'cognito-new-3', 'USER', NULL, now());

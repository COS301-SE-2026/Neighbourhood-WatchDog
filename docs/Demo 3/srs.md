...
| QR-08 | p95 latency stays under 4000ms at 500 concurrent virtual users at 200 RPS | Connection pooling + indexing | Locust load test | < 4000ms at 500 Virtual Users | 3800ms at 500 users at 195.52 RPS |
| QR-9 | Error rate at peak load | Connection pool limit | Locust | <1% | 0.11% |

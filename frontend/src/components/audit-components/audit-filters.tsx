...
export function AuditFilters({
    ...
    return (
        <div className="mb-6 flex flex-col gap-5 border-b border-border py-6">
            <input
                className="h-10 w-full rounded-md border border-border bg-brand-abyss px-3 text-sm text-brand-frost outline-none placeholder:text-brand-ash/60 focus:border-brand-green/60"
                type="text"
            ...
            <div className="flex flex-wrap items-end gap-5">
                <div className="flex flex-col gap-1">
                    <label className="text-sm font-medium text-brand-frost">Action</label>
                    <select
                        name="actions"
                ...
                <div className="flex flex-col gap-1">
                    <label className="text-sm font-medium text-brand-frost">From</label>
                    <input  
                        type="datetime-local"
                        className="h-10 rounded-md border border-border bg-brand-abyss px-3 text-sm text-brand-frost outline-none [color-scheme:dark] focus:border-brand-green/60"
                ...
                <div className="flex flex-col gap-1">
                    <label className="text-sm font-medium text-brand-frost">Up to</label>
                    <input
                        type="datetime-local"
                        className="h-10 rounded-md border border-border bg-brand-abyss px-3 text-sm text-brand-frost outline-none [color-scheme:dark] focus:border-brand-green/60"
                ...
                <div className="flex flex-col gap-1">
                    <label className="text-sm font-medium text-brand-frost">Sort</label>
                    <select
                        name="sortOrder"
                        className="h-10 rounded-md border border-border bg-brand-abyss px-3 text-sm text-brand-frost outline-none [color-scheme:dark] focus:border-brand-green/60"

        ...
        <>
            <main className="flex flex-1 items-center justify-center px-6 py-10">
                <div className="max-w-md text-center">
                    <h1 className="text-xl font-semibold text-brand-frost">
                    ...
                    <button
                        ...
                        className="mt-5 inline-flex items-center gap-2 rounded-md bg-brand-green px-4 py-2 text-sm font-medium text-brand-void transition-colors hover:bg-brand-green"
                    >

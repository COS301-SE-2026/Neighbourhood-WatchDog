...
async def get_neighbourhood_risk_threshold(neighbourhood_id: UUID, db: DbSession, claims: Annotated[dict ,Depends(NeighbourhoodMemberClaims)]):
...
async def update_neighbourhood_risk_threshold(neighbourhood_id: UUID, req: UpdateRiskThresholdConfigReq,db: DbSession, claims: Annotated[dict ,Depends(NeighbourhoodAdminClaims)]):
